    ...
    <main class="relative z-10">
      <section class="relative h-[70vh] flex items-center justify-center bg-black text-white">
        ...
        <div class="relative z-10 text-center px-6 max-w-3xl">
          <h1 class="text-4xl md:text-6xl font-bold mb-4">Car Walk Around</h1>
      ...
      <section class="bg-gradient-to-r from-primary to-secondary py-16 text-center text-white">
        <div class="max-w-3xl mx-auto px-4">
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button class="px-8 py-3 bg-transparent border-2 border-white text-white font-semibold rounded-full hover:bg-white/10 transition">
              View Inventory
            </button>
          </div>
        </div>
